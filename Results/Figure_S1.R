...
eam <- read.csv("H:\\Toolkit\\Mirror\\Comparison\\EAM\\v3\\eam_spearman.csv")

eam[,'method'] <- factor(eam[,'method'], levels = c("spearman"))
...
ggsave("G:/내 드라이브/ICP Lab/Comparison/Figures/figure_s1a.png", device = 'png',
       plot = t, width = 14, height = 21, dpi = "retina", units = 'in')
ggsave("G:/내 드라이브/ICP Lab/Comparison/Figures/figure_s1b.png", device = 'png',
