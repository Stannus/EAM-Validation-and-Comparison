eam <- read.csv("H:\\Toolkit\\Mirror\\Comparison\\EAM\\v3\\eam_best.csv")
...
ggsave("G:/내 드라이브/ICP Lab/Comparison/Figures/figure_8a.png", plot = t, width = 14, height = 11.5, dpi = "retina", units = "in")
ggsave("G:/내 드라이브/ICP Lab/Comparison/Figures/figure_8b.png", plot = p, width = 14, height = 11.5, dpi = "retina", units = "in")